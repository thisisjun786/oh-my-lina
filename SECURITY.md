...
LINA has no released versions yet. There is no response-time commitment.
...
The [CI policy](docs/policy/ci.md) defines isolation and execution requirements for external contributions.
